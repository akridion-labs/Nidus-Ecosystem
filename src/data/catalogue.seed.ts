...
export const seedProfiles: unknown[] = [
  {
    workId: 'lean-startup', modes: ['apply', 'explore'], topics: ['validation', 'experiments', 'company-building'],
  ...
  {
    workId: 'mom-test', modes: ['apply'], topics: ['customer-research', 'interviews', 'validation'],
  ...
  {
    workId: 'hard-thing', modes: ['apply'], topics: ['management', 'crisis', 'company-building'],
  ...
  {
    workId: 'five-rings', modes: ['explore', 'apply'], topics: ['strategy', 'discipline', 'craft'],
  ...
  {
    workId: 'bhagavad-gita', modes: ['enjoy', 'explore', 'apply'], topics: ['duty', 'composure', 'decision'],
  ...
  {
    workId: 'rich-dad', modes: ['explore'], topics: ['money', 'mindset'],
  ...
  {
    workId: 'deep-work', modes: ['apply', 'explore'], topics: ['focus', 'attention', 'craft'],
  ...
  {
    workId: 'thinking-fast-slow', modes: ['explore'], topics: ['judgement', 'bias', 'decision'],
    conceptualDifficulty: 4, typicalSessionMinutes: 25, actionability: 1, emotionalIntensity: 1,
    targetStages: [], competencyTags: [], prerequisites: [], tooEarlyStages: [], suggestedArtifact: null,
    provenance: EDITORIAL,
  },
  {
    workId: 'man-search-meaning', modes: ['enjoy', 'explore'], topics: ['meaning', 'endurance'],
  ...
  {
    workId: 'art-of-travel', modes: ['enjoy', 'explore'], topics: ['curiosity', 'travel', 'attention'],
    conceptualDifficulty: 2, typicalSessionMinutes: 10, actionability: 1, emotionalIntensity: 1,
    targetStages: [], competencyTags: [], prerequisites: [], tooEarlyStages: [], suggestedArtifact: null,
    provenance: EDITORIAL,
  },
  {
    workId: 'siddhartha', modes: ['enjoy', 'explore'], topics: ['meaning', 'solitude', 'journey'],
    conceptualDifficulty: 2, typicalSessionMinutes: 10, actionability: 0, emotionalIntensity: 2,
    targetStages: [], competencyTags: [], prerequisites: [], tooEarlyStages: [], suggestedArtifact: null,
    provenance: EDITORIAL,
  },
  {
    workId: 'old-man-sea', modes: ['enjoy'], topics: ['persistence', 'solitude'],
    conceptualDifficulty: 2, typicalSessionMinutes: 10, actionability: 0, emotionalIntensity: 2,
    targetStages: [], competencyTags: [], prerequisites: [], tooEarlyStages: [], suggestedArtifact: null,
    provenance: EDITORIAL,
  },
  {
    workId: 'malgudi-days', modes: ['enjoy'], topics: ['short-stories', 'everyday-life', 'india'],
    conceptualDifficulty: 1, typicalSessionMinutes: 5, actionability: 0, emotionalIntensity: 1,
    targetStages: [], competencyTags: [], prerequisites: [], tooEarlyStages: [], suggestedArtifact: null,
    provenance: EDITORIAL,
  },
  {
    workId: 'train-to-pakistan', modes: ['enjoy', 'explore'], topics: ['history', 'india', 'moral-choice'],
  ...
  {
    workId: 'siddhartha', modes: ['enjoy'], topics: [], conceptualDifficulty: 9, typicalSessionMinutes: 10,
